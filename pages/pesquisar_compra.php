...
<html lang="pt-br">
    ...
    <body>
        ...
        <nav class="navegacao">
            ...
            <form class="categoria" action="pesquisar_compra.php?num=<?php echo $n1?>" method="POST">
                <?php
        ...
        <main class="principal">
            <div class="conteudo">
				...
				<?php
                                ...
                                if(!isset($_POST['pesq'])){
                                    header("Location: pesquisar_compra.php?num=$n1");
                                    
                                }else{
                                    $valor_pesquisar = $_POST['pesq'];
                                ...
                                $result_psq = "SELECT * FROM bd_loja WHERE nome OR codigo LIKE '%$valor_pesquisar%' limit $incio, $quantidade_psq";
